...
export default function Header() {
  const [isNotificationsVisible, setIsNotificationsVisible] = useState(Boolean);
  const [isMessagesVisible, setIsMessagesVisible] = useState(Boolean);
  const [isProfileVisible, setIsProfileVisible] = useState(Boolean);

  return (
    <div className="relative flex flex-1 flex-col">
      <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-2xl">
